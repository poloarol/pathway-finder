...
const CanvasToSVG = {
  idCounter: 0,
  convert(sourceCanvas, targetSVG, x, y) {
    ...
    svgimg.setAttribute('x', x || 0);
    svgimg.setAttribute('y', y || 0);
...
var svgToString = function (svgcontent) {
  ...
  $.each(svgcontent.childNodes, (i, node) => {
  ...
  const output = svgToString(svgcontent, 0);
...
var svgToString = function (elem, indent) {
  const out = new Array();// , toXml;// = Utils.toXml;
